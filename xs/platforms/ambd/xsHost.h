...
extern uint32_t ambd_milliseconds();
extern void ambd_delay(uint32_t delayMS);
extern void ambd_restart();

#define modDelayMilliseconds(ms) ambd_delay(ms)
#define modDelayMicroseconds(us) ambd_delay(((us) + 500) / 1000)
#define modMilliseconds() ambd_milliseconds()
#define modMicroseconds() (uint32_t)(ambd_milliseconds() * 1000)

/*
	wlan
*/

int8_t ambd_wlan_enable(void);
int8_t ambd_wlan_disable(void);
int8_t ambd_wlan_get_active_device(void);
void ambd_wlan_set_active_device(uint8_t deviceId);
...
extern void ambd_error(char *msg, int err);
extern void ambd_msg_num(char *msg, int num);
