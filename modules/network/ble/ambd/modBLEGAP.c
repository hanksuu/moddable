...
{
	printf("xs_gap_whitelist_add unsupport \n");
}

void xs_gap_whitelist_remove(xsMachine *the)
{
	printf("xs_gap_whitelist_remove unsupport \n");
}

void xs_gap_whitelist_clear(xsMachine *the)
{
	printf("xs_gap_whitelist_clear unsupport \n");
}

int modBLEWhitelistContains(uint8_t addressType, uint8_t *address)
{
	printf("modBLEWhitelistContains unsupport \n");
	return 0;
}
